...
class OracleClientInstaller {
    constructor() {
        ...
        this.downloadUrls = {
            linux: {
                x64: {
                    basic: 'https://download.oracle.com/otn_software/linux/instantclient/218000/instantclient-basic-linux.x64-21.8.0.0.0dbru.zip',
                    sdk: 'https://download.oracle.com/otn_software/linux/instantclient/218000/instantclient-sdk-linux.x64-21.8.0.0.0dbru.zip'
                },
                arm64: {
                    basic: 'https://download.oracle.com/otn_software/linux/instantclient/218000/instantclient-basic-linux.arm64-21.8.0.0.0dbru.zip',
                    sdk: 'https://download.oracle.com/otn_software/linux/instantclient/218000/instantclient-sdk-linux.arm64-21.8.0.0.0dbru.zip'
                }
            },
            darwin: {
                x64: {
                    basic: 'https://download.oracle.com/otn_software/mac/instantclient/218000/instantclient-basic-macos.x64-21.8.0.0.0dbru.zip',
                    sdk: 'https://download.oracle.com/otn_software/mac/instantclient/218000/instantclient-sdk-macos.x64-21.8.0.0.0dbru.zip'
                },
                arm64: {
                    basic: 'https://download.oracle.com/otn_software/mac/instantclient/218000/instantclient-basic-macos.arm64-21.8.0.0.0dbru.zip',
    ...
    async checkSystemOracleClient() {
        ...
        try {
            ...
            const testCmd = this.platform === 'win32' ? 
                'where sqlplus' : 'which sqlplus || which instantclient || ls /opt/oracle/*/bin/sqlplus 2>/dev/null';
